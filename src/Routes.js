    ...
    <Router>
      <div>
        <Switch>
          ...
          <Route exact path="/get-employee" render={(props) => user ? <GetEmployeeID {...props}/> : <Redirect to="/home" />} />
          <Route exact path="/update-employee" render={(props) => user ? <UpdateEmp {...props}/> : <Redirect to="/home" />} />
          <Route exact path="/Delete-employee" render={(props) => user ? <DeleteEmp {...props}/> : <Redirect to="/home" />} />
